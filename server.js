...
var key = '0884f1ea696e48949dd8fab8caddbd02';
var city = "Denver";
...
function getHistory() {
	...
	// Allows the buttons to trigger a search as well
...
// Function to apply weather data to the 'Today' card and then launch the five-day forecast
...
// Initial load function to load example data for Denver
function initLoad() {
...
// Call the initial load function after the DOM has loaded
